...
function AppBar(props) {
  return (
    <header className="sticky-top bg-light">
      <nav className="navbar navbar-expand-lg navbar-light shadow p-0">
        <div className="container d-lg-flex w-100">
          <Link to="/" className="navbar-brand d-block p-0">
            <svg
              version="1.1"
              viewBox="0 0 400 400"
          ...
          >
            <ul className="navbar-nav mb-2 m-lg-0 text-start">
